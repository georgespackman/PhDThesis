...
BinderWidth=0.67
WarpWidth=2.00
ImportWeavePattern(cwd+"\\patterndraft6.txt")
#ImportWeavePattern(cwd+"\\3dv8_modified.txt")
#ImportWeavePattern(cwd+"\\Tmodel.txt")

NewDict, EndPositionDict, NumWarps, NumWefts, NumXYarns, BifStack=GetPatternInfo(cwd+"\\patterndraft6.txt")
...
for x in UpperWefts:
	...
	Yarn.AssignInterpolation( CInterpolationCubic( False, False, False) )
...
PrismMesh.SaveVoxelMesh(Textile, FileName, NumXVoxels, NumYVoxels, NumZVoxels, True, True, NO_BOUNDARY_CONDITIONS, 0, 1, 0)
