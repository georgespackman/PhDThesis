...
def WriteToInputExplicit(FileName):
	...
	file.write("*Equation" + "\n")
	file.write("2" + "\n")
	file.write("FLANGEBNODES, 2, 1." + "\n")
	file.write("CONSTRAINTSDRIVER2, 2, -1." + "\n")
	file.write("** Constraint: Eqn-4" + "\n")
	file.write("*Equation" + "\n")
	file.write("2" + "\n")
	file.write("FLANGEANODES, 2, 1." + "\n")
	file.write("CONSTRAINTSDRIVER1, 2, -1." + "\n")
	file.write("** Constraint: Eqn-5" + "\n")
	file.write("*Equation" + "\n")
	file.write("2" + "\n")
	file.write("FLANGEBNODES, 1, 1." + "\n")
	file.write("CONSTRAINTSDRIVER2, 1, -1." + "\n")
	file.write("** Constraint: Eqn-6" + "\n")
	file.write("*Equation" + "\n")
	file.write("2" + "\n")
	file.write("FLANGEANODES, 1, 1." + "\n")
	file.write("CONSTRAINTSDRIVER1, 1, -1." + "\n")
	file.write("** Constraint: Eqn-7" + "\n")
	file.write("*Equation" + "\n")
	file.write("2" + "\n")
	file.write("WEBNODES, 1, 1." + "\n")
	file.write("CONSTRAINTSDRIVER0, 1, -1." + "\n")
	file.write("*Amplitude, name=AMP-1, definition=SMOOTH STEP" + "\n")
	file.write("			 0.,              0.,            300.,              5." + "\n")
	...
	file.write("** Name: Disp-BC-1 Type: Symmetry/Antisymmetry/Encastre" + "\n")
	file.write("*Boundary" + "\n")
	file.write("CONSTRAINTSDRIVER1, PINNED" + "\n")
	file.write("** Name: Disp-BC-2 Type: Symmetry/Antisymmetry/Encastre" + "\n")
	file.write("*Boundary" + "\n")
	file.write("CONSTRAINTSDRIVER2, PINNED" + "\n")
	file.write("** Name: Disp-BC-3 Type: Displacement/Rotation" + "\n")
	file.write("*Boundary, amplitude=AMP-1" + "\n")
	file.write("CONSTRAINTSDRIVER0, 1, 1, -1" + "\n")
	...
	file.write("** HISTORY OUTPUT: H-Output-1" + "\n")
	file.write("**" + "\n") 
	file.write("*Output, history, time interval=0.00175" + "\n")
	file.write("*Energy Output" + "\n")
	file.write("ALLAE, ALLIE, ALLKE, ALLPD, ALLVD, ALLWK, ETOTAL" + "\n")
	file.write("**" + "\n") 
	file.write("** HISTORY OUTPUT: H-Output-2" + "\n")
	file.write("**" + "\n") 
	file.write("*Node Output, nset=CONSTRAINTSDRIVER0" + "\n")
	file.write("RF1, RF2, RF3, U1, U2, U3, V1, V2" + "\n")
	file.write("V3, VR1, VR2, VR3" + "\n")
	file.write("*End Step")
	file.close()
